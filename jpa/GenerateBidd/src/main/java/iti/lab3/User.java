...
public class User  implements java.io.Serializable {
    ...
    public User(String email, String address, String phone, String mobile, java.util.Date date, java.util.Date date2, String userName, String password, String fullName) {
        this.email = email;
        this.address = address;
        this.phone = phone;
        this.mobile = mobile;
