...
//   inverseJoinColumns = {@JoinColumn(name = "CATEGORY_ID", referencedColumnName = "ID")})
    ...
    public Product(Seller seller,String name, String description, String manufacturingName, java.util.Date date, java.util.Date date2, int quantity, java.util.Date date3, java.util.Date date4) {
        this.seller = seller;
        this.name = name;
